...
from mobilenet.mobilenet_without_bn import mobile_net as mb_without_bn
from mobilenet.mobilenet_with_bn import mobile_net as mb_with_bn
...
if __name__ == '__main__':
        ...
        #model = "./mobilenet/target_model.tar.gz"
        net = mb_with_bn(img_size, class_num)
        model = "./mobilenet/mobilenet_flowers102.tar.gz"
