...
def net_conf(mode, scale = 1.0):
    ...
    def conv_bn_layer(input, filter_size, num_filters,
                  ...
                  active_type=paddle.activation.Relu(), name = None):
        """
    ...
    conv1 = depthwise_separable(conv0,
    ...
    conv2 = depthwise_separable(conv1,
    ...
    conv3 = depthwise_separable(conv2,
    ...
    conv4 = depthwise_separable(conv3,
                              num_filters1=int(128*scale),
    ...
    conv5 = depthwise_separable(conv4,
    ...
    conv6 = depthwise_separable(conv5,
                              num_filters1=int(256*scale),
    ...
    conv12 = depthwise_separable(conv11,
                              num_filters1=int(512*scale),
    ...
    conv13 = depthwise_separable(conv12,
