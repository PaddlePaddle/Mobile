...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='merge batch normalization to Conv or Fc')
    parser.add_argument('--source_model', 
                        help='the source model that should be merged',
                        type=str)
    parser.add_argument('--dest_model',
...
if __name__ == "__main__":
    ...
    mb = Merge_BN(net, os.path.join(base_path, 'models', args.source_model), 
